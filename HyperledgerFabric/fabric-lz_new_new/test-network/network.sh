...
function networkUp() {
 ...
 # Print the docker-compose command to be executed
  echo "Executing docker-compose command:"
  echo "DOCKER_SOCK=${DOCKER_SOCK} ${CONTAINER_CLI_COMPOSE} ${COMPOSE_FILES} up -d 2>&1"
...
function createChannel() {
  ...
  [[ $len -lt 4 ]] || [[ ! -d "organizations/peerOrganizations" ]] && bringUpNetwork="false" || echo "Network Running Already"
...
function networkDown() {
  ...
  COMPOSE_ORG4_BASE_FILES="-f addOrg4/compose/compose-org4.yaml -f addOrg4/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-org4.yaml"
  COMPOSE_ORG4_COUCH_FILES="-f addOrg4/compose/compose-couch-org4.yaml -f addOrg4/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-couch-org4.yaml"
  COMPOSE_ORG4_CA_FILES="-f addOrg4/compose/compose-ca-org4.yaml -f addOrg4/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-ca-org4.yaml"
  ...
  COMPOSE_ORG5_BASE_FILES="-f addOrg5/compose/compose-org5.yaml -f addOrg5/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-org5.yaml"
  COMPOSE_ORG5_COUCH_FILES="-f addOrg5/compose/compose-couch-org5.yaml -f addOrg5/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-couch-org5.yaml"
  COMPOSE_ORG5_CA_FILES="-f addOrg5/compose/compose-ca-org5.yaml -f addOrg5/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-ca-org5.yaml"
  COMPOSE_ORG5_FILES="${COMPOSE_ORG5_BASE_FILES} ${COMPOSE_ORG5_COUCH_FILES} ${COMPOSE_ORG5_CA_FILES}"
  
  # stop org6 containers also in addition to org1 and org2, in case we were running sample to add org6
  COMPOSE_ORG6_BASE_FILES="-f addOrg6/compose/compose-org6.yaml -f addOrg6/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-org6.yaml"
  COMPOSE_ORG6_COUCH_FILES="-f addOrg6/compose/compose-couch-org6.yaml -f addOrg6/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-couch-org6.yaml"
  COMPOSE_ORG6_CA_FILES="-f addOrg6/compose/compose-ca-org6.yaml -f addOrg6/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-ca-org6.yaml"
  COMPOSE_ORG6_FILES="${COMPOSE_ORG6_BASE_FILES} ${COMPOSE_ORG6_COUCH_FILES} ${COMPOSE_ORG6_CA_FILES}"

  # stop org7 containers also in addition to org1 and org2, in case we were running sample to add org7
  COMPOSE_ORG7_BASE_FILES="-f addOrg7/compose/compose-org7.yaml -f addOrg7/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-org7.yaml"
  COMPOSE_ORG7_COUCH_FILES="-f addOrg7/compose/compose-couch-org7.yaml -f addOrg7/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-couch-org7.yaml"
  COMPOSE_ORG7_CA_FILES="-f addOrg7/compose/compose-ca-org7.yaml -f addOrg7/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-ca-org7.yaml"
  COMPOSE_ORG7_FILES="${COMPOSE_ORG7_BASE_FILES} ${COMPOSE_ORG7_COUCH_FILES} ${COMPOSE_ORG7_CA_FILES}"

  # stop org8 containers also in addition to org1 and org2, in case we were running sample to add org8
  COMPOSE_ORG8_BASE_FILES="-f addOrg8/compose/compose-org8.yaml -f addOrg8/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-org8.yaml"
  COMPOSE_ORG8_COUCH_FILES="-f addOrg8/compose/compose-couch-org8.yaml -f addOrg8/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-couch-org8.yaml"
  COMPOSE_ORG8_CA_FILES="-f addOrg8/compose/compose-ca-org8.yaml -f addOrg8/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-ca-org8.yaml"
  COMPOSE_ORG8_FILES="${COMPOSE_ORG8_BASE_FILES} ${COMPOSE_ORG8_COUCH_FILES} ${COMPOSE_ORG8_CA_FILES}"

  # stop org9 containers also in addition to org1 and org2, in case we were running sample to add org9
  COMPOSE_ORG9_BASE_FILES="-f addOrg9/compose/compose-org9.yaml -f addOrg9/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-org9.yaml"
  COMPOSE_ORG9_COUCH_FILES="-f addOrg9/compose/compose-couch-org9.yaml -f addOrg9/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-couch-org9.yaml"
  COMPOSE_ORG9_CA_FILES="-f addOrg9/compose/compose-ca-org9.yaml -f addOrg9/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-ca-org9.yaml"
  COMPOSE_ORG9_FILES="${COMPOSE_ORG9_BASE_FILES} ${COMPOSE_ORG9_COUCH_FILES} ${COMPOSE_ORG9_CA_FILES}"
  
    # stop org10 containers also in addition to org1 and org2, in case we were running sample to add org10
  COMPOSE_ORG10_BASE_FILES="-f addOrg10/compose/compose-org10.yaml -f addOrg10/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-org10.yaml"
  COMPOSE_ORG10_COUCH_FILES="-f addOrg10/compose/compose-couch-org10.yaml -f addOrg10/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-couch-org10.yaml"
  COMPOSE_ORG10_CA_FILES="-f addOrg10/compose/compose-ca-org10.yaml -f addOrg10/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-ca-org10.yaml"
  COMPOSE_ORG10_FILES="${COMPOSE_ORG10_BASE_FILES} ${COMPOSE_ORG10_COUCH_FILES} ${COMPOSE_ORG10_CA_FILES}"
  
    # stop org11 containers also in addition to org1 and org2, in case we were running sample to add org11
  COMPOSE_ORG11_BASE_FILES="-f addOrg11/compose/compose-org11.yaml -f addOrg11/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-org11.yaml"
  COMPOSE_ORG11_COUCH_FILES="-f addOrg11/compose/compose-couch-org11.yaml -f addOrg11/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-couch-org11.yaml"
  COMPOSE_ORG11_CA_FILES="-f addOrg11/compose/compose-ca-org11.yaml -f addOrg11/compose/${CONTAINER_CLI}/${CONTAINER_CLI}-compose-ca-org11.yaml"
  COMPOSE_ORG11_FILES="${COMPOSE_ORG11_BASE_FILES} ${COMPOSE_ORG11_COUCH_FILES} ${COMPOSE_ORG11_CA_FILES}"

  if [ "${CONTAINER_CLI}" == "docker" ]; then
    DOCKER_SOCK=$DOCKER_SOCK ${CONTAINER_CLI_COMPOSE} ${COMPOSE_FILES} ${COMPOSE_ORG3_FILES} ${COMPOSE_ORG4_FILES} ${COMPOSE_ORG5_FILES} ${COMPOSE_ORG6_FILES} ${COMPOSE_ORG7_FILES} ${COMPOSE_ORG8_FILES} ${COMPOSE_ORG9_FILES} ${COMPOSE_ORG10_FILES} ${COMPOSE_ORG11_FILES} down --volumes --remove-orphans
